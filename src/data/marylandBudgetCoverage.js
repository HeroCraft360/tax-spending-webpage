export const BUDGET_COVERAGE_SOURCES = [
  ...
  },
  {
    ...
    confidence: "High",
    coverageScore: 56,
    phase: "Phase 3B/3C normalization",
    ...
    adapterTasks: [
      "Extract project title, agency, county, authorization, and funding year from official documents.",
      "Separate bond bills, agency capital programs, and statewide facility programs.",
...
export const CAPITAL_PROJECT_PIPELINE = [
  {
    ...
    detail: "Project title, agency owner, county, and facility type must be extracted from official capital documents.",
  },
  {
    label: "Funding authority",
    status: "Source identified",
    detail: "Bond bills, capital budget authorizations, and DLS analyses need to stay separated until reconciled.",
  },
  {
...
export const COVERAGE_IMPLEMENTATION_STEPS = [
  ...
  },
  {
    ...
    status: "In progress",
    detail: "Vendor payments are live; grants/loans, funding sources, and capital projects still have adapter task cards and honest source status.",
    tasks: [
      "Vendor-payment adapter connected",
      "Capital-project normalization plan",

export const BUDGET_COVERAGE_SOURCES = [
  ...
  },
  {
    ...
    sourceUrl: "https://mtp.maryland.gov/",
    adapterTasks: [
      "Normalize vendor name, agency, fiscal year, payment total, and threshold notes.",
...
export const COVERAGE_IMPLEMENTATION_STEPS = [
  ...
  },
  {
    ...
    status: "In progress",
    detail: "Vendor payments, grants/loans, funding sources, and capital projects now have adapter task cards and honest source status.",
    tasks: [
      "Vendor-payment adapter plan",
